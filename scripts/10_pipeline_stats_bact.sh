...
#
# Usage : bash pipeline_stats_bact.sh
# =============================================================================
...
NR==FNR {
    ...
    # ── Rhizosphère ──────────────────────────
    if      (lineage ~ /(^|;)acidobacteriales(;|$)/)  group[genre] = "Acidobacteriales"
    else if (lineage ~ /(^|;)xanthomonadales(;|$)/)   group[genre] = "Xanthomonadales"
    else if (lineage ~ /(^|;)bradyrhizobium(;|$)/)    group[genre] = "Bradyrhizobium"
    else if (lineage ~ /(^|;)paraburkholderia(;|$)/)  group[genre] = "Paraburkholderia"
    else if (lineage ~ /(^|;)burkholderia(;|$)/)      group[genre] = "Burkholderia"
    else if (lineage ~ /(^|;)rhizobium(;|$)/)         group[genre] = "Rhizobium"
    else if (lineage ~ /(^|;)pseudomonas(;|$)/)       group[genre] = "Pseudomonas"
    else if (lineage ~ /(^|;)paenibacillus(;|$)/)     group[genre] = "Paenibacillus"
    else if (lineage ~ /(^|;)bacillus(;|$)/)          group[genre] = "Bacillus"
    else if (lineage ~ /(^|;)chitinophaga(;|$)/)      group[genre] = "Chitinophaga"
    else if (lineage ~ /(^|;)streptomyces(;|$)/)      group[genre] = "Streptomyces"
    else if (lineage ~ /(^|;)sphingomonas(;|$)/)      group[genre] = "Sphingomonas"
    else if (lineage ~ /(^|;)lysobacter(;|$)/)        group[genre] = "Lysobacter"
